...
public class AnnIndex : global::System.IDisposable {
  ...
  public byte[] QuantizeVector(byte[] p_data, int p_num) {
unsafe { fixed(byte* ptrp_data = p_data) { CSHARPSPTAGPINVOKE.WrapperArray tempp_data = new CSHARPSPTAGPINVOKE.WrapperArray( (System.IntPtr)ptrp_data, (ulong)p_data.LongLength );
      ...
      CSHARPSPTAGPINVOKE.WrapperArray data = CSHARPSPTAGPINVOKE.AnnIndex_QuantizeVector(swigCPtr,  tempp_data , p_num);
      if (CSHARPSPTAGPINVOKE.SWIGPendingException.Pending) throw CSHARPSPTAGPINVOKE.SWIGPendingException.Retrieve();
      byte[] ret = new byte[data._size];
      System.Runtime.InteropServices.Marshal.Copy(data._data, ret, 0, (int)data._size);
      if (data._size > 0) CSHARPSPTAGPINVOKE.deleteWrapperArray(data._data);
      return ret; 

} }
  }

  public byte[] ReconstructVector(byte[] p_data, int p_num) {
unsafe { fixed(byte* ptrp_data = p_data) { CSHARPSPTAGPINVOKE.WrapperArray tempp_data = new CSHARPSPTAGPINVOKE.WrapperArray( (System.IntPtr)ptrp_data, (ulong)p_data.LongLength );
    
      CSHARPSPTAGPINVOKE.WrapperArray data = CSHARPSPTAGPINVOKE.AnnIndex_ReconstructVector(swigCPtr,  tempp_data , p_num);
      if (CSHARPSPTAGPINVOKE.SWIGPendingException.Pending) throw CSHARPSPTAGPINVOKE.SWIGPendingException.Retrieve();
      byte[] ret = new byte[data._size];
      System.Runtime.InteropServices.Marshal.Copy(data._data, ret, 0, (int)data._size);
      if (data._size > 0) CSHARPSPTAGPINVOKE.deleteWrapperArray(data._data);
...
unsafe { fixed(byte* ptrp_meta = p_meta) { CSHARPSPTAGPINVOKE.WrapperArray tempp_meta = new CSHARPSPTAGPINVOKE.WrapperArray( (System.IntPtr)ptrp_meta, (ulong)p_meta.LongLength );
  ...
  public ulong CalculateBufferSize() {
    ulong ret = CSHARPSPTAGPINVOKE.AnnIndex_CalculateBufferSize(swigCPtr);
    if (CSHARPSPTAGPINVOKE.SWIGPendingException.Pending) throw CSHARPSPTAGPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public byte[] Dump(byte[] p_blobs) {
unsafe { fixed(byte* ptrp_blobs = p_blobs) { CSHARPSPTAGPINVOKE.WrapperArray tempp_blobs = new CSHARPSPTAGPINVOKE.WrapperArray( (System.IntPtr)ptrp_blobs, (ulong)p_blobs.LongLength );
    
      CSHARPSPTAGPINVOKE.WrapperArray data = CSHARPSPTAGPINVOKE.AnnIndex_Dump(swigCPtr,  tempp_blobs );
      if (CSHARPSPTAGPINVOKE.SWIGPendingException.Pending) throw CSHARPSPTAGPINVOKE.SWIGPendingException.Retrieve();
      byte[] ret = new byte[data._size];
      System.Runtime.InteropServices.Marshal.Copy(data._data, ret, 0, (int)data._size);
      if (data._size > 0) CSHARPSPTAGPINVOKE.deleteWrapperArray(data._data);
  ...
  public static AnnIndex LoadFromDump(byte[] p_config, byte[] p_blobs) {
unsafe { fixed(byte* ptrp_config = p_config) { CSHARPSPTAGPINVOKE.WrapperArray tempp_config = new CSHARPSPTAGPINVOKE.WrapperArray( (System.IntPtr)ptrp_config, (ulong)p_config.LongLength );
unsafe { fixed(byte* ptrp_blobs = p_blobs) { CSHARPSPTAGPINVOKE.WrapperArray tempp_blobs = new CSHARPSPTAGPINVOKE.WrapperArray( (System.IntPtr)ptrp_blobs, (ulong)p_blobs.LongLength );
    {
      AnnIndex ret = new AnnIndex(CSHARPSPTAGPINVOKE.AnnIndex_LoadFromDump( tempp_config ,  tempp_blobs ), true);
      return ret;
    }
} }
} }
